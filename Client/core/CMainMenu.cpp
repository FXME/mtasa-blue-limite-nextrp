...
#define CORE_MTA_HOVER_SCALE        0.6f
...
CMainMenu::CMainMenu(CGUI* pManager)
{
    ...
    m_pDisconnect = CreateItem(MENU_ITEM_DISCONNECT, "menu_disconnect.png", CVector2D(0.422f, fBase + fGap * 0));
    m_pDisconnect->image->SetVisible(false);

    // Create the menu items
    // Filepath, Relative position, absolute native size
    // And the font for the graphics is ?
    m_menuItems.push_back(CreateItem(MENU_ITEM_QUICK_CONNECT, "menu_quick_connect.png", CVector2D(0.420f, fBase + fGap * 0)));
    // m_menuItems.push_back(CreateItem(MENU_ITEM_BROWSE_SERVERS, "menu_browse_servers.png", CVector2D(0.38f, fBase + fGap * 1)));
    ...
    m_menuItems.push_back(CreateItem(MENU_ITEM_SETTINGS, "menu_settings.png", CVector2D(0.440, fBase + fGap * 1)));
    // m_menuItems.push_back(CreateItem(MENU_ITEM_ABOUT, "menu_about.png", CVector2D(0.168f, fBase + fGap * 5)));
    m_menuItems.push_back(CreateItem(MENU_ITEM_QUIT, "menu_quit.png", CVector2D(0.463f, fBase + fGap * 2)));
    ...
    m_menuAX = (0.420f * m_iMenuSizeX) + m_iXOff;                                                                      // Left side of the items
